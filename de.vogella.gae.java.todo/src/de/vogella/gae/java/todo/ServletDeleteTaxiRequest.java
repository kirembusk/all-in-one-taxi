...
public class ServletDeleteTaxiRequest extends HttpServlet {


	public void doPost(HttpServletRequest req, HttpServletResponse resp)
			throws IOException {
		System.out.println("Deleting Taxi Request... ");





		String ccID = checkNull(req.getParameter("ccID"));
		long id = 0;
		...
		Dao.INSTANCE.removeTaxiRequest(id);

		resp.sendRedirect("/TaxiRequestDelete.jsp");
	}
